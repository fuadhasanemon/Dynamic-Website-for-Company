<section id="blogs" class="blogs">
    ...
    <div class="section-title text-center">
        <span class="h1-responsive font-weight-bold text-center my-4 wow fadeInUp">Blogs</span>
        <h1 class="wow fadeInUp mb-3" data-wow-delay=".4s">Read Our Daily Blogs</h1>
    </div>
